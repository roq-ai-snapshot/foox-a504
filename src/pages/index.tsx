  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Foox - Your Ultimate Job Marketplace! Where companies meet freelancers and endless opportunities are just a click away."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Foox - Your Ultimate Job Marketplace! Where companies meet freelancers and endless opportunities are just a click away.`}
            </Text>
            <Box
