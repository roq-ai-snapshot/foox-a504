...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A Freelancer has applied for a job in your organization. Please review the application..create': {
    roles: ['owner', 'recruiter'],
    key: 'job_application',
    tenantPath: [],
    userPath: [],
  },
  'A new job has been posted in your organization. Please review the job details..create': {
    roles: ['owner', 'recruiter'],
    key: 'job_posting',
    tenantPath: [],
    userPath: [],
  },
  'The status of a job application in your organization has been updated. Please review the updated status..update': {
    roles: ['owner', 'recruiter'],
    key: 'job_application_status',
    tenantPath: [],
    userPath: [],
  },
};
